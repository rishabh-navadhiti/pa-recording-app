...
- Skills: `notes-claude/skills/{generate-note,generate-note-api,generate-note-prechart-api,create-doctor-profile,update-doctor-profile,edit-note,edit-note-api,add-icd-codes,cdi-review,cdi-costigan,em-score,patient-summary}/SKILL.md` (`generate-note-prechart-api` = `generate-note-api` + a PRE-CHART CONTEXT rule, used when a recording has captured pre-chart context)
